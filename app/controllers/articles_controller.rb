class ArticlesController <ApplicationController
  ...
  def create
    ...
    if @article.save
      flash[:success] = "News was successfully Uploaded"
  ...
  def destroy
    @article.destroy
    flash[:danger] = "News was successfully deleted"
  ...
  def article_params
    params.require(:article).permit(:title, :description, :picture, :video, category_ids: [])
  end

  def require_same_user
    if current_user != @article.user and !current_user.admin?
      flash[:danger] = "You can only Edit or Delete your own news"
